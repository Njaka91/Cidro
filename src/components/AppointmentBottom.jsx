    ...
    <div className="flex flex-col relative justify-center items-center gap-5 overflow-hidden px-32 pb-14 ">
      ...
      >
       ...
       left-1/2 transform -translate-x-1/2 -bottom-5 h-2 w-2 absolute rotate-45"
        ...
        <motion.div
          ref={ref}
          initial={{ x: 300, rotate: 270, opacity: 0 }} 
          animate={
            isInView
              ? { x: 0, rotate: 0, opacity: 1 }
              : { x: 300, rotate: 270, opacity: 0 }
          } 
          transition={{
            duration: 0.9,
            delay: 0.14,
          ...
          className="flex items-center justify-center relative bg-[#ff8e88] hover:bg-[#e9635c] h-12 w-12 rounded-full shadow-xl border-0 text-white font-medium group "
        >
          <span className="relative z-40 group inline-block">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span
              className="invisible opacity-0 -translate-y-2 text-center group-hover:visible group-hover:translate-y-0 group-hover:opacity-100 
               transition-all duration-[350ms] ease-in-out bg-[#e9635c] 
               left-1/2 transform -translate-x-1/2 -bottom-14 rounded-full p-2  absolute w-40"
            >
              Cidro.Cabinet
            </span>
            <span
              className="invisible opacity-0 -translate-y-2 text-center group-hover:visible group-hover:translate-y-0 group-hover:opacity-100 
       transition-all duration-[400ms] ease-in-out bg-[#e9635c]  
       left-1/2 transform -translate-x-1/2 -bottom-5 h-2 w-2 absolute rotate-45"
            />
          </span>
        </motion.div>
