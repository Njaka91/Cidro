...
const ImagesCareRight = ({ tilteLeft, descriptionLeft, imgLeft, prix, modalId,}) => {
  ...
  const opacityblur = useTransform(scrollYProgress, [0, 0.8], [1, 0]);
  ...
  const scalebutton = useTransform(scrollYProgress, [1, 0], [1, 0]);
    ...
    <div className="flex flex-row relative px-32 my-14 gap-12">
      <div className="relative flex w-1/2 flex-col text-[#1B2C51]">
        ...
        >
          <motion.p
            ...
            className="mt-4 text-justify line-h "
          >
            {descriptionLeft}
          </motion.p>
        </motion.div>
        ...
        <dialog id={modalId} className="modal modal-bottoms sm:modal-middle">
          <div className="flex flex-col modal-box justify-center bg-[#F5F5F5] items-center">
            <div className="relative mb-4">
              <h3 className="font-bold text-2xl text-fuchsia-900">
                {tilteLeft}
              </h3>
      ...
      <div className="relative w-1/2 h-[25rem]">
        ...
        >
          ...
          className="absolute overflow-hidden bg-slate-900/70 rounded-tr-3xl z-10 rounded-bl-3xl shadow-xl w-full h-full"/>
          <div className="absolute overflow-hidden rounded-tr-3xl rounded-bl-3xl shadow-xl w-full h-full">
            <img
              src={imgLeft}
              alt="dentiste"
...
export default ImagesCareRight;
